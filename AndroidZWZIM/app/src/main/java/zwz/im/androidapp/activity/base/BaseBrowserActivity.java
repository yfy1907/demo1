...
import zwz.im.androidapp.utils.X5WebView;
...
//                FrameLayout normalView = (FrameLayout) findViewByIdyId(R.id.web_filechooser);
...
//                myNormalView = normalView;
        ...
        mWebView.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String arg0, String arg1, String arg2, String arg3, long arg4) {
                ...
                new AlertDialog.Builder(BaseBrowserActivity.this)
    ...
    private void initBtnListenser() {
        ...
        mMore.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Toast.makeText(BaseBrowserActivity.this, "not completed", Toast.LENGTH_LONG).show();
            }
        });
