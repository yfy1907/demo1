...
public class VoiceFragment_bak extends BaseFragmentHome {
...
//        Glide.with(getContext()).load(R.drawable.confide).apply(options).into(iv_confide);
    ...
    private void initData() {
        for (int i = 0; i < 2; i++) {
            Fruit apple = new Fruit("最近遇到很多烦心事，下面我和大家说说吧", 0, "voice",null);
            fruitList.add(apple);
            Fruit banana = new Fruit("最长六字分类", 3, "voice",null);
            fruitList.add(banana);
            Fruit orange = new Fruit("最近遇到很多烦心事，下面我和大家说说吧",0, "voice",null);
            fruitList.add(orange);
            Fruit watermelon = new Fruit("分享", 1, "voice",null);
            fruitList.add(watermelon);
            Fruit pear = new Fruit("家庭", 2, "voice",null);
            fruitList.add(pear);
            Fruit grape = new Fruit("最长六字分类", 3, "voice",null);
            fruitList.add(grape);
            Fruit pineapple = new Fruit("家庭", 2, "voice",null);
            fruitList.add(pineapple);
            Fruit strawberry = new Fruit("最近遇到很多烦心事，下面我和大家说说吧", 0, "voice",null);
            fruitList.add(strawberry);
            Fruit cherry = new Fruit("最长六字分类", 3, "voice",null);
            fruitList.add(cherry);
            Fruit mango = new Fruit("分享", 1, "voice",null);
            fruitList.add(mango);
        }
    }
