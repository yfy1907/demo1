...
public class ConnectRecyclerViewPageTopicAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{

    public static final String TAG = "ConnectTopicAdapter";
    // 普通布局
...
//    private onRecyclerItemClick mOnRecyclerItemClick;
    ...
    public ConnectRecyclerViewPageTopicAdapter(Context context, List<Fruit> pDataList) {
        mContext = context;
        dataList = pDataList;
    }
