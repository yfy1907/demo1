...
public class ConnectTopicListViewAdapter extends BaseAdapter implements ListAdapter {
    ...
    public ConnectTopicListViewAdapter(List<Fruit> mlistData, Context mcontext){
        listData = mlistData;
        context = mcontext;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycle_item_g, parent, false);
